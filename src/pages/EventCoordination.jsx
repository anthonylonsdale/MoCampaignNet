...
import EventsContainer from '../eventcoords/EventsContainer.jsx'
import styles from './EventCoordination.module.css'
              ...
              <>
                <div className={styles.userContainer}>
                  ...
                  <div className={styles.titleContainer}>
                    <Text className={styles.interactiveTitle} onClick={() => navigate('/campaign-tools')}>Event Coordination</Text>
                  </div>
                  <div>
